...
class ConnectWidget(QtGui.QWidget):
    def __init__(self, parent, ip_path=None):
        ...
        self.lay_connectButton = QtGui.QHBoxLayout()
        self.lay_connectionInfo = QtGui.QHBoxLayout()
        ...
        for i in range(3):
            self.lay_connectButton.addWidget(self.line[i])
            self.lay_connectButton.addWidget(self.point[i])
        self.lay_connectButton.addWidget(self.line[3])     
        ...
        self.lay_connectButton.addWidget(self.connect_button)
        
        self.lay.addLayout(self.lay_connectButton)
        
        
        self.connection_info = QtGui.QLabel('')
        self.lay_connectionInfo.addWidget(self.connection_info)     
        
        self.lay.addLayout(self.lay_connectionInfo)
